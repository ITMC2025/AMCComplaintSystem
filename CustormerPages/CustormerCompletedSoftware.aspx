<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster/Custormer.Master" AutoEventWireup="true" CodeBehind="CustormerCompletedSoftware.aspx.cs" Inherits="AMCComplaintSystem.CustormerPages.CustormerCompletedSoftware" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        <asp:Label ID="lblUserName" runat="server" Text="Label"></asp:Label>
        Your Completed Software Jobs Report</h2>
