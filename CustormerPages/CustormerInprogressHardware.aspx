<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster/Custormer.Master" AutoEventWireup="true" CodeBehind="CustormerInprogressHardware.aspx.cs" Inherits="AMCComplaintSystem.CustormerPages.CustormerInprogressHardware" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        <asp:Label ID="lblUserName" runat="server" Text="Label"></asp:Label>
        Your Inprogress Hardware Jobs Report</h2>
