<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster/Custormer.Master" AutoEventWireup="true" CodeBehind="CustormerPendingHardware.aspx.cs" Inherits="AMCComplaintSystem.CustormerPages.CustomerPendingReport" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        <asp:Label ID="lblUserName" runat="server" Text="Label"></asp:Label>
        Your Pending Hardware Jobs Report</h2>
