<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster/Custormer.Master" AutoEventWireup="true" CodeBehind="CustormerPendingSoftware.aspx.cs" Inherits="AMCComplaintSystem.CustormerPages.CustormerPendingSoftware" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        <asp:Label ID="lblUserName" runat="server" Text="Label"></asp:Label>
        Your Pending Software Jobs Report </h2>
