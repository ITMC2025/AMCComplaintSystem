<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster/Engineer.Master" AutoEventWireup="true" CodeBehind="EngineerCompleteJob.aspx.cs" Inherits="AMCComplaintSystem.EngineerPages.EngineerCompleteJob" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="recent-complaints" style="margin-top: 20px; width: 100%;">
        <h3 style="text-align: center; color: #333;">Yours Completed Jobs</h3>
        ...
        <asp:GridView ID="gvPendingComplaints" runat="server" 
            ...
            style="width: 100%; margin-top: 10px; border: 1px solid #ddd; border-collapse: collapse;" OnPageIndexChanging="gvPendingComplaints_PageIndexChanging" OnSelectedIndexChanged="gvPendingComplaints_SelectedIndexChanged" >
            ...
            <table class="form-table">
                ...
                <tr>
                 ...
                 <tr>
                     <td>
                         <label>
                         Complaint Inprogress Date:</label></td>
                     <td class="auto-style1">
                         <asp:TextBox ID="txtInprogress" runat="server" CssClass="textbox" ReadOnly="true"></asp:TextBox>
                     </td>
                </tr>
                 <tr>
                    ...
                    <td class="auto-style1">
                        <asp:DropDownList ID="ddlStatus" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlJobFilter_SelectedIndexChanged">
                            ...
                            <asp:ListItem Value="InProgress">Inprogress</asp:ListItem>
                             <asp:ListItem Selected="True" Value="Completed">Completed</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
                  <tr>
