<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster/Engineer.Master" AutoEventWireup="true" CodeBehind="EngineerInprogressHardware.aspx.cs" Inherits="AMCComplaintSystem.EngineerPages.EngineerInprogressHardware" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        <asp:Label ID="lblUserName" runat="server" Text="Label"></asp:Label>
        Your In Progress Hardware Jobs Report </h2>
