...
{
	public partial class EngineerCompletedHardware : System.Web.UI.Page
	{
        ...
        private void LoadComplaints(int actionType, string category)
        {
            ...
            string engineerId = Session["UserID"].ToString();
            string connString = ConfigurationManager.ConnectionStrings["AMC"].ConnectionString;

            using (SqlConnection conn = new SqlConnection(connString))
            {
                using (SqlCommand cmd = new SqlCommand("sp_GetEngineerCompletedComplaintsByType", conn))
                {
