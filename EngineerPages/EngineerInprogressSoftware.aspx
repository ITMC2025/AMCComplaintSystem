<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster/Engineer.Master" AutoEventWireup="true" CodeBehind="EngineerInprogressSoftware.aspx.cs" Inherits="AMCComplaintSystem.EngineerPages.EngineerInprogressSoftware" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        <asp:Label ID="lblUserName" runat="server" Text="Label"></asp:Label>
        Your In Progress Software Jobs Report </h2>
