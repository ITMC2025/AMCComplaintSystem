...
{
	public partial class EngineerStartJob : System.Web.UI.Page
	{
        ...
        private void LoadComplaintsByCategory(int engineerId, string cat)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("sp_GetEngineerPendingComplaintsByType", conn);
        ...
        protected void gvPendingComplaints_RowDeleted(object sender, GridViewDeletedEventArgs e)
        {
        ...
        protected void gvPendingComplaints_PageIndexChanging1(object sender, GridViewPageEventArgs e)
        {
            gvPendingComplaints.PageIndex = e.NewPageIndex;
            string selectedCat = ddlJobFilter.SelectedValue;
            int engineerId = Convert.ToInt32(Session["UserID"]);
