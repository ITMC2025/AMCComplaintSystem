<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster/Admin.Master" AutoEventWireup="true" CodeBehind="AdminCompleteSoftware.aspx.cs" Inherits="AMCComplaintSystem.AdminPages.AdminCompleteSoftware" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      <h2>
          Completed Software Jobs Report</h2>
  <asp:GridView ID="gvCompletedComplaints" runat="server" AutoGenerateColumns="False" CssClass="report-table">
      <Columns>
