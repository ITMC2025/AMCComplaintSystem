<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster/Admin.Master" AutoEventWireup="true" CodeBehind="AdminInprogressHardware.aspx.cs" Inherits="AMCComplaintSystem.AdminPages.AdminInprogressHardware" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      <h2>
          Inprogress Hardware Jobs Report</h2>
  <asp:GridView ID="gvInprogressComplaints" runat="server" AutoGenerateColumns="False" CssClass="report-table">
      <Columns>
